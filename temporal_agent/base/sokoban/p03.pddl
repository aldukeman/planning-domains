...
(define (problem p001-multiban-temporal)
  ...
  (:init
    ...
    (player-at player-01 pos-02-02)
    (player-at player-02 pos-09-04)
    (player-at player-03 pos-06-05)
    (stone-at stone-01 pos-03-03)
    (stone-at stone-02 pos-08-04)
    (stone-at stone-03 pos-07-05)
    (at-goal stone-02)
    (at-goal stone-03)
    (clear pos-01-07)
    (clear pos-02-04)
