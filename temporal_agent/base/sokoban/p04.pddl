...
(define (problem p012-hexoban-temporal)
  ...
  (:init
    ...
    (player-at player-01 pos-08-04)
    (player-at player-02 pos-05-07)
    (player-at player-03 pos-11-07)
    (stone-at stone-01 pos-04-04)
    (stone-at stone-02 pos-12-04)
    (stone-at stone-03 pos-06-06)
    (stone-at stone-04 pos-08-06)
    (stone-at stone-05 pos-10-06)
    (clear pos-01-01)
    (clear pos-01-03)
    (clear pos-01-07)
    (clear pos-02-08)
