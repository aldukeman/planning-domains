...
(define (problem p008-hexoban-temporal)
  ...
  (:init
    ...
    (player-at player-01 pos-08-08)
    (player-at player-02 pos-10-08)
    (stone-at stone-01 pos-06-06)
    (stone-at stone-02 pos-08-06)
    (stone-at stone-03 pos-10-06)
    (stone-at stone-04 pos-09-07)
    (at-goal stone-04)
    (clear pos-01-01)
    (clear pos-01-03)
    (clear pos-01-05)
