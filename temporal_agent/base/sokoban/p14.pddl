...
(define (problem p017-hexoban-temporal)
  ...
  (:init
    ...
    (MOVE-DIR pos-01-05 pos-03-05 dir-east)
    ...
    (MOVE-DIR pos-02-04 pos-03-05 dir-southeast)
    (MOVE-DIR pos-02-04 pos-04-04 dir-east)
    (MOVE-DIR pos-02-06 pos-01-05 dir-northwest)
    (MOVE-DIR pos-02-06 pos-01-07 dir-southwest)
    (MOVE-DIR pos-02-06 pos-03-05 dir-northeast)
    ...
    (MOVE-DIR pos-03-05 pos-01-05 dir-west)
    (MOVE-DIR pos-03-05 pos-02-04 dir-northwest)
    (MOVE-DIR pos-03-05 pos-02-06 dir-southwest)
    ...
    (MOVE-DIR pos-04-04 pos-02-04 dir-west)
    ...
    (MOVE-DIR pos-05-01 pos-06-02 dir-southeast)
    ...
    (MOVE-DIR pos-06-02 pos-05-01 dir-northwest)
    (MOVE-DIR pos-06-02 pos-05-03 dir-southwest)
    (MOVE-DIR pos-06-02 pos-07-01 dir-northeast)
    ...
    (MOVE-DIR pos-07-01 pos-06-02 dir-southwest)
    ...
    (MOVE-DIR pos-13-07 pos-14-08 dir-southeast)
    ...
    (MOVE-DIR pos-14-08 pos-13-07 dir-northwest)
    (MOVE-DIR pos-14-08 pos-16-08 dir-east)
    ...
    (MOVE-DIR pos-16-08 pos-14-08 dir-west)
    ...
    (at player-03 pos-04-08)
    (at player-04 pos-16-08)
    (at stone-01 pos-11-03)
    (at stone-02 pos-10-04)
    (at stone-03 pos-11-05)
    (at stone-04 pos-08-06)
    (at stone-05 pos-05-07)
    (at stone-06 pos-07-07)
    (at stone-07 pos-11-07)
    (at stone-08 pos-13-07)
    (at stone-09 pos-14-08)
    (at-goal stone-02)
    (at-goal stone-06)
    (at-goal stone-08)
    (clear pos-01-01)
